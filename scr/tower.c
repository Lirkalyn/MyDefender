...
sfIntRect set_rect_spr(sfIntRect rect_spr)
{
    rect_spr.top = 4;
    rect_spr.left = 5;
    rect_spr.width = 80;
...
tow *fill_first(tow *towe, sfTexture* tex_f)
{
    ...
    towe[0].rect_spr = set_rect_spr(towe[0].rect_spr);
...
tow *fill_second(tow *towe, sfTexture* tex_i)
{
    ...
    towe[1].rect_spr = set_rect_spr(towe[1].rect_spr);
...
tow *fill_last(tow *towe, sfTexture* tex_o)
{
    ...
    towe[2].rect_spr = set_rect_spr(towe[2].rect_spr);
